...
typeIerrorrate=function(criticalvalue, cov, K, requiredtypeIerrorrate) #find prob of rejecting hypothesis 1 similar in notation to Wason et al,  SMMR 2017:
{
...
{set.seed(seed)
  ...
  rejecth0 <- simulation.new(K=K, wei_shape=shape, hazard.null=hazard.null, hazard.exp=hazard.exp, hazard.censoring=hazard.censoring, followuptime=followuptime, n1.perarm=n1.perarm, n2=n2, criticalvalue=criticalvalue, interimanalysisfollowup=interimanalysisfollowup, recruitmentrate=recruitmentrate, niterations=nit)
